...
export default function AdminPage() {
    ...
    const handleAddNew = () => {
        ...
        const fresh: Client = {
            id,
            subdomain: "newclient.agency.com",
            status: "active",
            data: emptyHotel("New Client"),
        };
        upsertClient(fresh);
        setEditingId(id);
    };
                ...
                <>
                    ...
                    <aside className="hidden w-64 shrink-0 flex-col border-r border-neutral-200 bg-white md:flex">
                        ...
                        <nav className="flex flex-1 flex-col gap-1 p-3">
                            ...
                            />
                            <Link
                                href="/bookingsmanagement"
                                className="flex items-center gap-2 rounded-md px-3 py-2 text-sm text-neutral-600 transition hover:bg-neutral-100"
                            >
                        ...
                        <div className="border-t border-neutral-200 p-3">
                            <SidebarItem icon={<LogOut className="h-4 w-4" />} label="Logout" onClick={() => { }} />
                        </div>
                    </aside>
...
function SidebarItem({
    ...
    return (
        <button
            onClick={onClick}
            className={`flex items-center gap-2 rounded-md px-3 py-2 text-left text-sm transition ${active
        ...
        <div className="flex h-screen w-full overflow-hidden">
            ...
            <section className="flex h-full w-[35%] min-w-[380px] flex-col border-r border-neutral-200 bg-white">
                ...
                <div className="flex-1 overflow-y-auto p-5">
                    <ClientEditor client={draft} onChange={setDraft} onDelete={onDelete} />
                </div>
            </section>
